Module Module1
	Public Sub angka(sender As Object, e As KeyPressEventArgs)
	...
	Public Sub huruf(sender As Object, e As KeyPressEventArgs)
    ...
    Public Nama, Umur, JK, Hobi, Alamat, Hp, Gambar As String
